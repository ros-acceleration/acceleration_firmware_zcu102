...
set(TEMPLATE_MIXIN "${CMAKE_BINARY_DIR}/zcu102.mixin.template")
set(TEMPLATE_YAML "${CMAKE_BINARY_DIR}/index.yaml.template")
set(MIXIN_DIR "${FIRMWARE_DIR}/mixin")
set(MIXIN "${MIXIN_DIR}/zcu102.mixin")
...
run("${TESTFIRMWARE} colcon mixin remove zcu102 2> /dev/null")  # clean up prior stuff
set(ADD_MIXIN_PATH "file://${FIRMWARE_DIR}/mixin/index.yaml")
run("${TESTFIRMWARE} colcon mixin add zcu102 ${ADD_MIXIN_PATH}")
# message("ADD_MIXIN_PATH: " ${ADD_MIXIN_PATH})
run("${TESTFIRMWARE} colcon mixin update zcu102")
